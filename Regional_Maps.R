...
load("data/processed_data/HDD_Regional_2020.RData") #NERC_HDD_Region
load("data/processed_data/CDD_Regional_2020.RData") #NERC_CDD_Region
...
#Save the plots
pdf("figures/Regional_CONUS.pdf", height=1850/300, width=5000/300)
